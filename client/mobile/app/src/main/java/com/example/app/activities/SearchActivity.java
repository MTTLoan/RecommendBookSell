...
public class SearchActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        images8.add(new Book.Image("https://salt.tikicdn.com/ts/product/18/08/cb/f09cdf8650d2f2a3f397ef968a312783.jpg",
                "345mno678pqr901stu234vwx.png"));
        bookList.add(new Book(
                3,
                "Bộ ba phép thuật - Úm ba la ánh sáng hiện ra", "Bộ sách tranh kể về chuyến phiêu lưu trong thế giới phép thuật của gấu Hoggs cùng hai người bạn chồn Poki và thỏ Fips. Bộ ba cưỡi thảm thần, học thần chú, gặp những nhân vật có phép thuật như phù thủy, nàng tiên cá, tiên nhỏ, Qua đó các bé học được những bài học nhỏ về lòng dũng cảm, tình bạn và việc dọn nhà rất vui!!   Bộ sách gồm 3 cuốn:     Gấu Hoggs dũng cảm   Úm ba la ánh sáng hiện ra!   Úm ba la biến ra nhà sạch!   Giá sản phẩm trên Tiki đã bao gồm thuế theo luật hiện hành.",
                images3,
                45000.0,
                4.5,
                10,
        ...
        bookList.add(new Book(
                4,
                "WHO? Chuyện Kể Về Danh Nhân Thế Giới", "\"WHO? Chuyện Kể Về Danh Nhân Thế Giới - Dành cho bé từ 6 - 15 tuổi   Lời nói đầu     Hồi nhỏ, Nikola Tesla đã vô cùng ngạc nhiên khi nhìn thấy tia sét trên bầu trời ngày mưa. Cậu bé ước mơ nghiên cứu về điện năm ấy về sau đã trở thành nhà khoa học, mở ra kỉ nguyên dòng điện xoay chiều bằng phát minh ra động cơ và máy phát điện xoay chiều. Nikola Tesla là nhà khoa học thiên tài không màng tới tiền bạc hay danh vọng, ông dành trọn cuộc đời cống hiến vì lợi ích của nhân loại.",
                images4,
                52000.0,
                4.2,
                8,
